...
# This script no longer runs successfully, likely since
# the removal condition no longer exists.
################ Script #######################
...
mt_contract_account = m.solidity_create_contract(open("goest/contracts/MarketToken.vy","r"), crytic_compile_args=dict(), owner=market_owner_account, args=[market_owner_account, market_owner_balance])
...
et_contract_account = m.solidity_create_contract(open("goest/contracts/EtherToken.vy","r"), crytic_compile_args=dict(), owner=ether_owner_account, args=[ether_owner_account, ether_owner_balance])
...
voting_contract_account = m.solidity_create_contract(open("goest/contracts/Voting.vy","r"), crytic_compile_args=dict(), owner=voting_owner_account, args=[mt_contract_account.address])
...
args = [mt_contract_account.address, voting_contract_account.address, arg_1, arg_2, arg_3, arg_4, arg_5, arg_6, arg_7, arg_8, arg_9]
p_contract_account = m.solidity_create_contract(open("goest/contracts/Parameterizer.vy","r"), crytic_compile_args=dict(), owner=param_owner_account, args=args)
...
reserve_contract_account = m.solidity_create_contract(open("goest/contracts/Reserve.vy","r"), crytic_compile_args=dict(), owner=reserve_owner_account, args=[et_contract_account, mt_contract_account, p_contract_account])
...
datatrust_contract_account = m.solidity_create_contract(open("goest/contracts/Datatrust.vy","r"), crytic_compile_args=dict(), owner=datatrust_owner_account, args=[et_contract_account, voting_contract_account, p_contract_account, reserve_contract_account])
...
listing_contract_account = m.solidity_create_contract(open("goest/contracts/Listing.vy","r"), crytic_compile_args=dict(), owner=listing_owner_account, args=[mt_contract_account, voting_contract_account, p_contract_account, reserve_contract_account, datatrust_contract_account])
...
voting_contract_account.setPrivileged(p_contract_account, datatrust_contract_account, listing_contract_account, caller=voting_owner_account)
