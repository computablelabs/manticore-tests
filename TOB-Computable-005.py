...
# This script no longer executes, likely since the
# error in question has been closed off.
################ Script #######################
...
market.listing_contract.getListing(user_list_hash)
...
market.listing_contract.resolveChallenge(user_list_hash, caller=attacker_account)
market.voting_contract.getStake(user_list_hash, market.ether_token_owner)
